namespace Escritorio
{
    ...
    public partial class RendimientoDelAlumno : Form
    {
        private Dictionary<string, int> rendimientoAlumno;

        public RendimientoDelAlumno(Dictionary<string, int> rendimientoAlumno)
        {
            InitializeComponent();
            
            this.rendimientoAlumno = rendimientoAlumno;
        ...
        private void InicializarGrafico()
        {
            ...
            foreach (var item in this.rendimientoAlumno)
            {
